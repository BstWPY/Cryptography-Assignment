'''
对于平均阶-N的关系,代码和CryptographyDesign_main.py基本相同,
外套N循环即可
'''
import math
...
f1=open("C:/Users/WangPY/Desktop/code/CryptographyDesign/Logistic.txt",'w')
f2=open("C:/Users/WangPY/Desktop/code/CryptographyDesign/Singer.txt",'w')
f3=open("C:/Users/WangPY/Desktop/code/CryptographyDesign/Iterative.txt",'w')
for n in range(1,500):
    ...
    #计算平均阶
    avecountx=str(sum(countx1)//len(countx1))
    avecounty=str(sum(county1)//len(county1))
    avecountz=str(sum(countz1)//len(countz1))     
    f1.write(str(n)+' '+avecountx+'\n')
    f2.write(str(n)+' '+avecounty+'\n')
    f3.write(str(n)+' '+avecountz+'\n')
f1.close()
f2.close()
f3.close()